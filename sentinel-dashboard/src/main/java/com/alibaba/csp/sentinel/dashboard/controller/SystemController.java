...
public class SystemController {
	...
	public Result<List<SystemRuleEntity>> apiQueryMachineRules(String app, String ip, Integer port) {
		...
		try {
			...
			// sentinelApiClient.fetchSystemRuleOfMachine(app, ip, port);
			List<SystemRuleEntity> rules = systemRuleProvider.getRules(app, ip, port);
	...
	private boolean publishRules(String app, String ip, Integer port) {
		...
		try {
			return this.systemRulePublisher.publish(app, ip, port, rules);
		} catch (Exception e) {
