...
//            List<DegradeRuleEntity> rules = sentinelApiClient.fetchDegradeRuleOfMachine(app, ip, port);
			List<DegradeRuleEntity> rules = degradeRuleProvider.getRules(app, ip, port);
...
//        return sentinelApiClient.setDegradeRuleOfMachine(app, ip, port, rules);
		try {
			return degradeRulePublisher.publish(app, ip, port, rules);
		} catch (Exception e) {
			logger.info("Publish degrade rules failed, app={}, ip={}, port={}", app, ip, port, e);
			return false;
		}
	}
