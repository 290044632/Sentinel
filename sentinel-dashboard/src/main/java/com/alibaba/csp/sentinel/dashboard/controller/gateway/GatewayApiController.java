...
public class GatewayApiController {
	...
	private ApiDefinitionProvider apiDefinitionProvider;

	@Autowired
	private ApiDefinitionPublisher apiDefinitionPublisher;
	...
	public Result<List<ApiDefinitionEntity>> queryApis(String app, String ip, Integer port) {
		...
		try {
			// List<ApiDefinitionEntity> apis = sentinelApiClient.fetchApis(app, ip,
			// port).get();
			List<ApiDefinitionEntity> apis = this.apiDefinitionProvider.getRules(app, ip, port);
	...
	private boolean publishApis(String app, String ip, Integer port) {
		...
		try {
			return this.apiDefinitionPublisher.publish(app, ip, port, apis);
		} catch (Exception e) {
			logger.error("update gateway api error:", e);
			return false;
		}
