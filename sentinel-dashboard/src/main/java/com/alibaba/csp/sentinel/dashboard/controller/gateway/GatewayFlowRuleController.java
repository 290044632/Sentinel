...
public class GatewayFlowRuleController {
	...
	private GatewayFlowRuleProvider gatewayFlowRuleProvider;

	@Autowired
	private GatewayFlowRulePublisher gatewayFlowRulePublisher;
	...
	public Result<List<GatewayFlowRuleEntity>> queryFlowRules(String app, String ip, Integer port) {
		...
		try {
			...
			List<GatewayFlowRuleEntity> rules = this.gatewayFlowRuleProvider.getRules(app, ip, port);
	...
	private boolean publishRules(String app, String ip, Integer port) {
		...
		try {
			...
			return this.gatewayFlowRulePublisher.publish(app, ip, port, rules);
		} catch (Exception e) {
